...
<tr style="color:red!important"><td><b>S.N.</b></td><td><b>Quiz</b></td><td><b>Question Solved</b></td><td><b>Right</b></td><td><b>Wrong<b></td><td><b>Score</b></td>';
$c=0;
while($row=mysqli_fetch_array($q) )
{
$eid=$row['eid'];
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="mahee.jpg" width=100 height=100 alt="MaheeNur" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="https://web.facebook.com/maheenur.lucky13/" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Jahidun Nur Mahee</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">01730381915</h4>
		<h4 style="font-family:'typo' ">differentmahee13@gmail.com</h4>
